 ...
 */
// Shape matches an arc quiz question exactly — { q, o: options, a: answerIndex, e } —
// so the review and spaced-repetition machinery can serve these without a special
// case. Diverging shapes were the reason they could not be reviewed at all.
export const LESSON_ARC = "lessons";   // synthetic arc id these live under

export const CHECKS = {
  // ---- 01 what a stop loss is
  "lesson-01a": { q: "When do you pick the price where you'd be wrong?",
    o: ["Before you buy", "After it starts falling", "When it feels bad"], a: 0,
  ...
  "lesson-01b": { q: "You set a stop and price hits it. What did the stop do?",
    o: ["Kept a $20 loss from becoming $150", "Lost you money", "Stopped you winning"], a: 0,
  ...
  "lesson-01c": { q: "$20 of risk, and your stop is $0.50 away. How many shares?",
    o: ["40 shares", "20 shares", "200 shares"], a: 0,
  ...
  "lesson-02a": { q: "On a $2,000 account, what's the most one trade should cost you?",
    o: ["$20", "$200", "Whatever it takes"], a: 0,
    e: "1% of $2,000 is $20. Not $200, and not 'a bit'." },
  "lesson-02b": { q: "Why does risking 25% a trade end the game?",
    o: ["Four bad trades and there's no fifth", "It's against the rules", "Fees get too high"], a: 0,
  ...
  "lesson-03c": { q: "What's the difference between a ticker and a slice?",
    o: ["A slice is part of a business; a ticker is a colour that moves",
        "Nothing, they're the same", "A ticker costs less"], a: 0,
  ...
  "lesson-03d": { q: "Does anyone have to buy your slice at the price you want?",
    o: ["No — and that's the whole risk", "Yes, the app guarantees it", "Only on weekdays"], a: 0,
    e: "Nobody owes you your price. That's why lesson 01 came first." },

  // ---- 04 position size
  "lesson-04a": { q: "What decides how many shares you buy?",
    o: ["How far away your stop is", "How much you like the company", "How much cash you have"], a: 0,
  ...
  "lesson-04b": { q: "Same $20 risk, but the stop is now $1.00 away. How many shares?",
    o: ["20 shares", "40 shares", "80 shares"], a: 0,
  ...
  "lesson-04c": { q: "You decide you want 200 shares first. What just happened?",
    o: ["The size chose your risk instead of you", "Nothing, that's fine", "You saved on fees"], a: 0,
  ...
  "lesson-04d": { q: "What comes first, every single time?",
    o: ["The stop", "The share count", "The target"], a: 0,
  ...
  "lesson-05a": { q: "Can you be right only 40% of the time and still make money?",
    o: ["Yes, if the wins are bigger than the losses", "No, you need over 50%", "Only with luck"], a: 0,
  ...
  "lesson-05b": { q: "Six losses at $20 and four wins at $50. Where do you end up?",
    o: ["$80 ahead", "$40 behind", "Exactly even"], a: 0,
    e: "−$120 + $200 = +$80. The size of the wins did the work." },
  "lesson-05c": { q: "Which is more dangerous?",
    o: ["A 90% win rate with one huge loss", "A 40% win rate with small losses", "Neither"], a: 0,
  ...
  "lesson-06a": { q: "Price bounced near $10.20 twice. What does that suggest?",
    o: ["People remember it as a good price", "It can never go lower", "It's a rule of the market"], a: 0,
    e: "Levels come from memory, not magic — and memory can change its mind." },
  "lesson-06b": { q: "What actually makes a level matter?",
    o: ["Lots of people remembering the same number", "The exact price", "How round the number is"], a: 0,
  ...
  "lesson-06c": { q: "A floor breaks and price falls through. What often happens next?",
    o: ["That floor becomes the new ceiling", "It always bounces back", "The level stops existing"], a: 0,
    e: "The same number keeps mattering — just from the other side now." },

  // ---- 07 trend
  "lesson-07a": { q: "What makes an uptrend an uptrend?",
    o: ["Higher highs and higher lows", "Lots of green candles", "It went up today"], a: 0,
  ...
  "lesson-07b": { q: "Does a trend tell you what happens tomorrow?",
    o: ["No — it describes what has happened", "Yes, that's the point", "Only in an uptrend"], a: 0,
  ...
  "lesson-07c": { q: "How many states can price be in?",
    o: ["Three — up, down, sideways", "Two — up or down", "As many as you like"], a: 0,
    e: "And most of the time it's sideways. Sideways is an answer too." },

  // ---- 08 the setup
  "lesson-08a": { q: "When is a setup decided?",
    o: ["In advance, before you're allowed in", "While the trade is running", "After it closes"], a: 0,
  ...
  "lesson-08b": { q: "Why does a written rule beat a feeling?",
    o: ["You can check it later; a feeling can't be checked", "Rules are always right",
        "Feelings are never useful"], a: 0,
  ...
  "lesson-08c": { q: "What can you do with a rule that you can't do with a hunch?",
    o: ["Repeat it, and tell a good loss from a stupid one", "Win more often", "Skip the stop"], a: 0,
  ...
  "lesson-09a": { q: "You followed your rule exactly and still lost $20. That trade was…",
    o: ["A good trade", "A bad trade", "A mistake to fix"], a: 0,
  ...
  "lesson-09b": { q: "Which one is actually dangerous?",
    o: ["Breaking your rule and getting paid anyway", "Following your rule and losing",
        "Following your rule and winning"], a: 0,
  ...
  "lesson-09c": { q: "Why write the trade down at all?",
    o: ["Your memory rewrites what happened", "To show someone", "For tax reasons"], a: 0,
  ...
  "lesson-10a": { q: "Which is NOT one of the three ways people lose?",
    o: ["Picking the wrong company", "Trading too big", "Moving the stop"], a: 0,
  ...
  "lesson-10b": { q: "You move your stop because you don't want to be wrong yet. What did that cost?",
    o: ["The loss you agreed to became one you didn't", "Nothing, it's flexible", "A small fee"], a: 0,
    e: "$20 became $40, then $96 — and now it takes five wins to undo one decision." },
  "lesson-10c": { q: "What's the whole edge, in one line?",
    o: ["Survive long enough to get good", "Find the best stocks", "Win more than you lose"], a: 0,
